...
module.exports = {
  ...
  viaSheetId: process.env.GOOGLE_VIA_SHEET_ID || process.env.GOOGLE_SHEET_ID,
  googleEmail: google.email,
  googleKey: google.key,
  notifyHour: Number(process.env.NOTIFY_HOUR || 8),
  uidCheckTimes: process.env.UID_CHECK_TIMES || "12:00,16:00",
  uidRealtimeIntervalSeconds: Math.max(15, Number(process.env.UID_REALTIME_INTERVAL_SECONDS) || 60),
